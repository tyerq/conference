...
public class SetAnnouncementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Iterable<Conference> iterable = OfyService.ofy().load()
        ...
        if (conferenceNames.size() > 0) {
            ...
            memcacheService.put(Constants.MEMCACHE_ANNOUNCEMENTS_KEY, new Announcement(announcementStringBuilder.toString()));
        }
